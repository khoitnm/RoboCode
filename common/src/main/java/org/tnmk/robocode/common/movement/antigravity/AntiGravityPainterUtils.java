...
public class AntiGravityPainterUtils {
    ...
    private static final Color COLOR_FINAL_DESTINATION = new Color(21, 255, 255);
    ...
    public static void paintFinalDestination(AdvancedRobot robot, Point2D destination) {
        PaintHelper.paintPoint(robot.getGraphics(), 12, COLOR_FINAL_DESTINATION, destination, null);
    }
