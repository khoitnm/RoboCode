...
import voidiousdiamond.voidious.gfx.RoboGraphic;
import voidiousdiamond.voidious.gun.GunDataManager.GunDataListener;
import voidiousdiamond.voidious.utils.BattleField;
import voidiousdiamond.voidious.utils.DiaUtils;
import voidiousdiamond.voidious.utils.Enemy;
import voidiousdiamond.voidious.utils.KnnView;
import voidiousdiamond.voidious.utils.MovementPredictor;
import voidiousdiamond.voidious.utils.RobotState;
import voidiousdiamond.voidious.utils.TimestampedFiringAngle;
import voidiousdiamond.voidious.utils.Wave;
import voidiousdiamond.voidious.utils.Wave.WavePosition;
import voidiousdiamond.voidious.utils.WaveManager;
...
public class GunEnemy extends Enemy<TimestampedFiringAngle> {
  ...
  public List<Double> hitLocations;
  ...
  public GunEnemy(String botName, double distance, double energy,
      Double location, int round, long time, double heading,
  ...
  GunEnemy(String botName, double distance, double energy,
    ...
    timeMovingAtMe = 0;
    lastWaveFired = null;
    hitLocations = new ArrayList<Double>();
  }
  ...
  public void execute(final long currentTime, long lastBulletFiredTime,
      double bulletPower, double currentGunHeat, Double myLocation,
  ...
  void updateWave(Wave w, Double myLocation, double bulletPower,
  ...
  void processWaveBreak(Wave w, List<RobotState> waveBreakStates,
    ...
    Double dispVector = w.displacementVector(waveBreakState);
  ...
  public Wave processBulletHit(Bullet bullet, long currentTime,
    ...
    Double bulletLocation = bulletLocation(bullet);
  ...
  void logWave(Wave w, Double dispVector, double guessFactor, long time,
      boolean isVisit) {
  ...
  public Wave newGunWave(Double sourceLocation,
      Double targetLocation, int fireRound, long fireTime,
  ...
  private WaveManager.CurrentWaveListener newUpdateWaveListener(
      final Double myLocation, final double bulletPower,
